"""ReportGenerator for real-time-disease-monitor v2.
...
class ReportGenerator:
    """Primary report_generator handler for real-time-disease-monitor.
    ...
    def initialize(self) -> None:
        if self._initialized:
            return
        logger.info("Initializing report_generator for real-time-disease-monitor")
